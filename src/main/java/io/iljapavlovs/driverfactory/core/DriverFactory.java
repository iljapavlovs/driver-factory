...
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.ENABLE_VIDEO;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.ENABLE_VNC;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.PROXY_ENABLED;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.PROXY_HOST;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.PROXY_PORT;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.REMOTE_DRIVER;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_RETRY_COUNT;
import static io.iljapavlovs.driverfactory.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_URL;
import static io.iljapavlovs.driverfactory.core.DriverType.FIREFOX;
import static org.openqa.selenium.Proxy.ProxyType.MANUAL;
import static org.openqa.selenium.remote.CapabilityType.PROXY;

import io.iljapavlovs.driverfactory.config.ApplicationProperties;
