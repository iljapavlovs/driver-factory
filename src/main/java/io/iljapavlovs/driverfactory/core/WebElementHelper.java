...
import static io.iljapavlovs.driverfactory.config.Constants.WAIT_SHORT_SECONDS;
...
public class WebElementHelper {
    ...
    public static void waitForVisibility(WebElement element) {
        ...
        try {
            ...
            throw new RuntimeException("Element '" + element + "' not found after waiting for it's visibility");
        } catch (NoSuchElementException ne) {
            log.error(ne.getMessage());
            throw new RuntimeException("Element '" + element + "' not found, unable to locate it in the DOM");
        } catch (Exception e) {
